...
- The contract integrates the [BTC relay](https://docs.gobob.xyz/docs/contracts/src/src/relay/LightRelay.sol/contract.LightRelay) to enable seamless communication between the Bitcoin blockchain and the BOB testnet.
...
In Advance Configration choose configration file before compiling.
